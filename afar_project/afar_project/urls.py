...
from assetinfo import views as asset_info
urlpatterns = [
    ...
    path('asset_info/',asset_info.asset_info,name="asset_info"),
    path('current_asset_info/',asset_info.current_asset_info,name="current_asset_info"),
